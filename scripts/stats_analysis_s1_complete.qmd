...
```
```{r}
# Compute similarity (correlation) between two state-mean matrices.
# Returns a K x K matrix: correlations between states in mat1 vs states in mat2.
